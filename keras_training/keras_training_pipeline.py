...
EPOCHS = 15
MODEL_PATH = TRAINED_MODELS_DIR / "zebra_model_3.keras"
...
def main():
    ...
    plot_probability_histogram(
        labels=val_labels,
        probs=val_probs,
        output_path=TRAINED_MODELS_DIR / "validation_probability_histogram_3.png",
    )

    plot_precision_recall_curve(
        labels=val_labels,
        probs=val_probs,
        output_path=TRAINED_MODELS_DIR / "validation_precision_recall_curve_3.png",
    )
